...
public class PostProcessOutline : ScriptableRendererFeature
{
    ...
    public class OutlineSettings
    {
        public Material outlineMaterial = null;
        public int scale = 1;
        public float depthThreshold = 0.6f;
        public float normalThreshold = 0.6f;
        public float depthNormalThreshold = 0.6f;
        public float depthNormalThresholdScale = 1.0f;
    }
    ...
    public override void Create()
    {
        ...
        settings.outlineMaterial.SetFloat("_Scale", settings.scale);
        ...
        settings.outlineMaterial.SetFloat("_DepthNormalThreshold", settings.depthNormalThreshold);
        settings.outlineMaterial.SetFloat("_DepthNormalThresholdScale", settings.depthNormalThresholdScale);
