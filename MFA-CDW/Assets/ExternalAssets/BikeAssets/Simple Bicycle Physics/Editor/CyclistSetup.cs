    ...
    internal static class AnimationRiggingEditorUtils
    {
        internal static class AnimationRiggingContextMenus
        {
            ...
            static void RigSetup(MenuCommand command)
            {
                ...
                GameObject TemplatePrefab = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/ExternalAssets/BikeAssets/Simple Bicycle Physics/Editor/TemplatePrefab.prefab", typeof(GameObject));
